...
public final class ConnectionFactory {
	...
	private static final Logger LOGGER = LogFactory.getLogger(ConnectionFactory.class);
	...
	private static Properties loadProperties() {
		...
		try (InputStream input = ConnectionFactory.class.getClassLoader().getResourceAsStream("db.properties")) {
			...
			throw new RuntimeException("Driver JDBC n�o encontrado: " + properties.getProperty(DRIVER), e);
		}
	}
	...
	public static Connection getConnection() throws SQLException {
		...
		LOGGER.fine("Abrindo conex�o com o banco.");
